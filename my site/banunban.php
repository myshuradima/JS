...
if(intval($q)==1){
  while($row = $result->fetch_assoc()){
    echo '<div class style="background-color: #4CAF50; font-size: 20pt; ">' . "Username:" . $row['username'] . "<br />" . '</div><div style="background-color: #4CAF50;"><form action = "Ban.php" method="post">' .
