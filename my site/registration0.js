//document.getElementById('registrationcheck').onclick =
function checkeverything(){
  ...
  if(a==1){
    ...
    document.getElementById('registrationusername').value = username;
    document.getElementById('registrationemail').value = email;
    document.getElementById('registrationpassword').value = password;
    document.getElementById('registrationrepeatpassword').value = repeatpassword;
  }
}
